...
const RemoveModal = ({isOpen, onClose, onConfirm}) => {
  ...
  return <div className="modal" tabIndex="-1" ref={modalRef}>
    <div className="modal-dialog modal-dialog-centered">
      <div className="modal-content">
        ...
        <div className="modal-footer">
          <button type="button" className="btn btn-outline-secondary" data-bs-dismiss="modal">بیخیال</button>
          <button type="button" className="btn btn-danger" onClick={handleConfirm}>تایید</button>
        </div>
      </div>
    </div>
  </div>
